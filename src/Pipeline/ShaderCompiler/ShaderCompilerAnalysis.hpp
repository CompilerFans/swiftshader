#ifndef SWIFTSHADER_PIPELINE_SHADER_COMPILER_SHADER_COMPILER_ANALYSIS_HPP_
#define SWIFTSHADER_PIPELINE_SHADER_COMPILER_SHADER_COMPILER_ANALYSIS_HPP_
...
enum class ShaderStaticFragmentKind : uint32_t
{
	None = 0,
	ConstantColor = 1,
	FragCoordQuadrants = 2,
	FrontFacingBinaryColors = 3,
	PointCoordGradient = 4,
	FlatInterpolatedColor = 5,
	InterpolatedColor = 6,
	InterpolatedColorBlueNearFragDepth = 7,
	FragCoordDiscardLeftConstantColor = 8,
};
...
#endif  // SWIFTSHADER_PIPELINE_SHADER_COMPILER_SHADER_COMPILER_ANALYSIS_HPP_
