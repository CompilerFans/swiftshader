#ifndef SWIFTSHADER_PIPELINE_SHADER_COMPILER_CODEGEN_TARGET_HPP_
#define SWIFTSHADER_PIPELINE_SHADER_COMPILER_CODEGEN_TARGET_HPP_
...
struct NormalizedAbiDescription
{
	...
	bool operator==(const NormalizedAbiDescription &rhs) const
	{
		return header.descriptorSetCount == rhs.header.descriptorSetCount &&
		       ...
		       compilerAnalysis.staticFragmentKind == rhs.compilerAnalysis.staticFragmentKind &&
		       compilerAnalysis.colorR == rhs.compilerAnalysis.colorR &&
		       compilerAnalysis.colorG == rhs.compilerAnalysis.colorG &&
		       compilerAnalysis.colorB == rhs.compilerAnalysis.colorB &&
		       compilerAnalysis.colorA == rhs.compilerAnalysis.colorA;
	}
};

}  // namespace sw

#endif  // SWIFTSHADER_PIPELINE_SHADER_COMPILER_CODEGEN_TARGET_HPP_
